...
class SwatS1CPS(MiniCPS):
    ...
    def __init__(self, name, net):
        ...
        # start devices
        plc1, plc2, plc3, s1, attacker, analysis = self.net.get(
            'plc1', 'plc2', 'plc3', 's1', 'attacker', 'analysis')
        ...
        s1.cmd('cd /home/robbiemcgugan/Documents/refined/swat && ' + sys.executable + ' -u ' + ' physical_process.py  &> logs/process.log &')
        plc2.cmd('cd /home/robbiemcgugan/Documents/refined/swat && ' + sys.executable + ' -u ' +' plc2.py &> logs/plc2.log &')
        plc3.cmd('cd /home/robbiemcgugan/Documents/refined/swat && ' + sys.executable + ' -u ' + ' plc3.py  &> logs/plc3.log &')
        plc1.cmd('cd /home/robbiemcgugan/Documents/refined/swat && ' + sys.executable + ' -u ' + ' plc1.py &> logs/plc1.log &')
...
class SwatEnv(gym.Env):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        attacker = self.env.net.get('attacker')
    ...
    def step(self, action):
        ...
        if self.i == 2:
            attacker = self.env.net.get('attacker')
            attacker.cmd('cd /home/robbiemcgugan/Documents/refined/swat && ' + sys.executable + ' -u ' + ' dos.py  &> logs/attacker.log &')
    ...
    def calculate_immediate_reward(self, metrics):
        ...
        # 1. Inter-arrival time (higher is better in normal operation)
        ...
        # 2. CIP ratio (higher is better in normal operation)
        ...
        # 3. Packet count (lower is better during attack)
        ...
        # 4. Request/Response ratio (closer to 1 is better)
